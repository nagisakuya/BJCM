...
create_text_and_enum!(TextKey,load_texts,
    ...
    (GeneralSettingWSL,["Dsiable calculate on WSL","WSLでの計算を無効化"]),
    (GeneralSettingWSLInstalled,["Available","利用可能です"]),
    (GeneralSettingWSLNotInstalled,["Not available","利用不可能です"]),
    (HowToUseButton,["HowToUse","説明書"]),
    ...
    (ActivationErrorInvalidChar,["Invalid char in the activation code.","アクティベーションコードの中に不正な文字があります"]),
